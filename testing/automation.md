...
- Reduces repetitive testing effort x
...
# Evaluate these statements about test automation:
...
- Test automation completely replaces the need for testers f
- Maintenance of automated tests is important t
